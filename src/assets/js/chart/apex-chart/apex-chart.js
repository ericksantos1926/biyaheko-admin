                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                if ((T.attr("index", a), m && T.attr({ "clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")") }), "none" !== A.config.states.normal.filter.type)) S.getDefaultFilter(T, a);
                ...
                a(t, [
                        ...
                        value: function (t, e) {
                            ...
                            for (var r = 0, o = 0; r < t.length; r++, o++) {
                                ...
                                for (var P = a.group({ class: "apexcharts-datalabels" }), z = 0, E = i.globals.dataPoints; z < i.globals.dataPoints; z++, E--) {
                                    ...
                                    var M = null;
                                    this.isHorizontal
                                        ? ((M = this.drawBarPaths({ indexes: { i: r, j: z, realIndex: y, bc: o }, barHeight: S, strokeWidth: A, pathTo: g, pathFrom: f, zeroW: d, x: x, y: b, yDivision: h, elSeries: k })),
                                          (C = this.series[r][z] / this.invertedYRatio))
                                        : ((M = this.drawColumnPaths({ indexes: { i: r, j: z, realIndex: y, bc: o }, x: x, y: b, xDivision: l, pathTo: g, pathFrom: f, barWidth: C, zeroH: c, strokeWidth: A, elSeries: k })),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            var S = this.calculateDataLabelsPos({ x: c, y: d, i: n, j: s, series: u, realIndex: e, barHeight: f, barWidth: x, renderedPath: A, visibleSeries: m });
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            var b = e,
                                ...
                                S = { width: 0, height: 0 };
                            return (
                                d.config.dataLabels.enabled && (S = u.getTextRects(d.globals.yLabelFormatters[0](d.globals.maxY), parseFloat(y.style.fontSize))),
                                (v = this.isHorizontal
                                ...
                                this.drawCalculatedDataLabels({ x: v.dataLabelsX, y: v.dataLabelsY, val: r[a][s], i: n, j: s, barWidth: l, barHeight: o, textRects: S, dataLabelsConfig: y })
                            );
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (c.enabled && !m) {
                                ...
                                this.isHorizontal && a < 0 && ("start" === c.textAnchor ? (k.textAnchor = "end") : "end" === c.textAnchor && (k.textAnchor = "start")),
                                    g.plotDataLabelsText({ x: e, y: i, text: v, i: this.barOptions.distributed ? n : s, j: n, parent: b, dataLabelsConfig: k, alwaysDrawDataLabel: !0, offsetCorrection: !0 });
                            }
                            return b;
                        },
                    },
                        ...
                        value: function (t, e) {
                            ...
                            for (var n = this.graphics.group({ class: "apexcharts-bar-series apexcharts-plot-series" }), r = 0, o = 0, l = 0, h = 0; l < t.length; l++, h++) {
                                ...
                                for (var M = 0; M < i.globals.dataPoints; M++) {
                                    ...
                                    var T = null;
                                    this.isHorizontal
                                        ? ((T = this.drawBarPaths({ indexes: { i: l, j: M, realIndex: y, bc: h }, barHeight: L, strokeWidth: S, pathTo: c, pathFrom: d, zeroW: b, x: r, y: o, yDivision: f, elSeries: k })),
                                          (P = this.series[l][M] / this.invertedYRatio))
                                        : ((T = this.drawColumnPaths({ indexes: { i: l, j: M, realIndex: y, bc: h }, x: r, y: o, xDivision: g, pathTo: c, pathFrom: d, barWidth: P, zeroH: x, strokeWidth: S, elSeries: k })),
                        ...
                        value: function (t, e) {
                            ...
                            for (var r = a.group({ class: "apexcharts-candlestick-series apexcharts-plot-series" }), o = 0, l = 0; o < t.length; o++, l++) {
                                ...
                                for (var P = a.group({ class: "apexcharts-datalabels" }), z = 0, E = i.globals.dataPoints; z < i.globals.dataPoints; z++, E--) {
                                    ...
                                    var M,
                                        T = this.drawCandleStickPaths({ indexes: { i: o, j: z, realIndex: v, bc: l }, x: f, y: x, xDivision: h, pathTo: d, pathFrom: g, barWidth: A, zeroH: c, strokeWidth: S, elSeries: y });
                                ...
                                if (
                                    ...
                                    if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                                        ...
                                        var z = i.globals.dataLabels.style.colors[d],
                                            E = s.drawText({ x: A, y: S, text: L, textAnchor: "middle", fontSize: i.config.dataLabels.style.fontSize, fontFamily: i.config.dataLabels.style.fontFamily, foreColor: z });
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
                                ...
                                if ((p.setAttrs(M.node, { "data:angle": z, "data:value": t.series[m] }), e.config.chart.dropShadow.enabled)) {
                ...
                a(i, [
                        ...
                        value: function (t, e) {
                            ...
                            for (var n = a.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), r = 0, o = 0; r < t.length; r++, o++) {
                                ...
                                for (var S = a.group({ class: "apexcharts-datalabels" }), L = 0, P = i.globals.dataPoints; L < i.globals.dataPoints; L++, P--) {
                                    ...
                                    var z = null;
                                    this.isHorizontal
                                        ? (k = (z = this.drawRangeBarPaths({ indexes: { i: r, j: L, realIndex: m, bc: o }, barHeight: w, strokeWidth: y, pathTo: g, pathFrom: f, zeroW: d, x: x, y: b, yDivision: h, elSeries: v })).barWidth)
                                        : (w = (z = this.drawRangeColumnPaths({ indexes: { i: r, j: L, realIndex: m, bc: o }, x: x, y: b, xDivision: l, pathTo: g, pathFrom: f, barWidth: k, zeroH: c, strokeWidth: y, elSeries: v }))
                                              .barHeight),
                                        (g = z.pathTo),
                                        (f = z.pathFrom),
                                        (b = z.y),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            void 0 !== this.series[c][d] && null !== this.series[c][d] && ((g = o + this.seriesRangeStart[c][d] / this.invertedYRatio), (f = o + this.seriesRangeEnd[c][d] / this.invertedYRatio)),
                                h.move(o, x),
                                (n = h.move(o, x)),
                        ...
                        value: function (t, e, i) {
                            ...
                            for (var d = this.xyRatios.zRatio, g = this.xyRatios.xRatio, f = this.xyRatios.baseLineY, x = [], b = [], m = 0, v = 0; v < t.length; v++) {
                                ...
                                var V = T,
                                    ...
                                    j = E,
                                    U = 0;
                                if (((j = this.determineFirstPrevY({ i: v, series: t, yRatio: c[this.yaxisIndex], zeroY: E, prevY: j, prevSeriesY: b, lineYPosition: U }).prevY), S.push(j), (G = j), null === t[v][0])) {
                                ...
                                for (var $ = a.globals.dataPoints > 1 ? a.globals.dataPoints - 1 : a.globals.dataPoints, J = 0; J < $; J++) {
                                    ...
                                    a.config.chart.stacked
                                        ? ((U = v > 0 && a.globals.collapsedSeries.length < a.config.series.length - 1 ? b[v - 1][J + 1] : E),
                                          (I =
                                        ...
                                        P.push(T),
                                        S.push(I);
                                    var tt = this.createPaths({ series: t, i: v, j: J, x: T, y: I, xDivision: k, pX: V, pY: G, areaBottomY: M, linePath: X, areaPath: Y, linePaths: D, areaPaths: O, seriesIndex: i });
                                    (O = tt.areaPaths), (D = tt.linePaths), (V = tt.pX), (G = tt.pY), (Y = tt.areaPath), (X = tt.linePath), this.appendPathFrom && ((F += s.line(T, E)), (R += s.line(T, E)));
                                    var et = this.calculatePoints({ series: t, x: T, y: I, realIndex: A, i: v, j: J, prevY: j, categoryAxisCorrection: m, xRatio: g });
                                ...
                                for (var d = 0; d < s.series[c].length; d++) {
                                    ...
                                    null !== g && u.isNumber(g)
                                        ? ((n = Math.max(n, h[c][d])),
                                          ...
                                          u.isFloat(g) && ((g = u.noExponents(g)), (s.yValueDecimal = Math.max(s.yValueDecimal, g.toString().split(".")[1].length))),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            var i = this.w.globals,
                                a = {};
                            return (
                                this.isFormat2DArray() ? (a = this.handleRangeDataFormat("array", t, e)) : this.isFormatXY() && (a = this.handleRangeDataFormat("xy", t, e)), i.seriesRangeStart.push(a.start), i.seriesRangeEnd.push(a.end), a
                            );
                        },
                    },
                    {
                            ...
                            if (t.globals.isBarHorizontal) {
                                ...
                                if (t.config.grid.yaxis.lines.show)
                                    for (var f = 0, x = 0, b = t.globals.gridWidth, m = 0; m < t.globals.dataPoints + 1; m++) {
                                        ...
                                        s.add(v), v.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(v, { y1: f + 20, y2: x + 20 }, { y1: f, y2: x }), (x = f += t.globals.gridHeight / t.globals.dataPoints);
                                    }
                            } else {
                                ...
                                if (t.config.grid.yaxis.lines.show)
                                    for (var M = 0, T = 0, I = t.globals.gridWidth, X = 0; X < o + 1; X++) {
                                        ...
                                        s.add(Y), Y.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(Y, { y1: M + 20, y2: T + 20 }, { y1: M, y2: T }), (T = M += t.globals.gridHeight / o);
                                    }
                            }
                ...
                a(t, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            a && r[e] && (r = s.config.tooltip.custom[e]), (n.innerHTML = r({ ctx: this.ctx, series: s.globals.series, seriesIndex: e, dataPointIndex: i, w: s }));
                        },
                    },
                ]),
                t
                ...
                switch (t[0]) {
                    ...
                    case "A":
                        t = (e = (function (t, e) {
                            ...
                            for (b[0][0] = b[0][1].clone(), b[b.length - 1][2] = b[b.length - 1][1].clone(), s = new SVG.Matrix().rotate(M).scale(z, E).rotate(-M), k = 0, A = b.length; k < A; k++)
